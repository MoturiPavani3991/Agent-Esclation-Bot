...
app1.get('/webhook/', (req, res) => {
	...
	if (req.query['hub.verify_token'] === 'Demo') {
				...
				if (body.docs.length != 0) {
					if (body.docs[0].botActive == false) {
						var check= setTimeout(function() {
							loginSend(FbUserId, "We are disconneting you from the Agent");
						}, 30000);
						if(body.docs[0].botActive == false && respBasicData!=null){
							myStopFunction();
						}
